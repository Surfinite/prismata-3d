...
# Frontend (custom node route)
check "Fabrication Terminal installed" test -f /opt/comfyui/custom_nodes/fabricate/web/index.html
check "Frontend manifest present" test -f /opt/comfyui/custom_nodes/fabricate/web/manifest.json
check "Frontend route module" test -f /opt/comfyui/custom_nodes/fabricate/__init__.py
